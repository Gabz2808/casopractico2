...
namespace CAAP2.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,FullName,Email,IsPremium,CreatedAt")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,FullName,Email,IsPremium,CreatedAt")] User user)
        {
            if (ModelState.IsValid)
            {
